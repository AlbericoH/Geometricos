...
public class Jogo7Activity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jogo7);
    ...
    private void funcCalcular(){
        ...
        if((confere1 == 1) && (confere2 == 1)){
            ...
            Toast.makeText(Jogo7Activity.this, "Acertou! Soma = " + String.valueOf(total), Toast.LENGTH_SHORT).show();
