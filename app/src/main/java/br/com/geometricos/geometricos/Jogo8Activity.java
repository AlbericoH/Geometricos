...
public class Jogo8Activity extends AppCompatActivity implements View.OnClickListener{
    ...
    private void funcCalcular(){
        ...
        if((confere1 == 1) && (confere2 == 1)){
            ...
            Toast.makeText(Jogo8Activity.this, "Acertou! Soma = " + String.valueOf(total), Toast.LENGTH_SHORT).show();
