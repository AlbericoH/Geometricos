...
public class Jogo3Activity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for(int i=0; i<arrayList.size(); i++){
            switch (arrayList.get(i)){
                case 10: textView1.setBackgroundColor(Color.parseColor("#00ff00")); break;
                case 11: textView2.setBackgroundColor(Color.parseColor("#00ff00")); break;
                case 12: textView3.setBackgroundColor(Color.parseColor("#00ff00")); break;
            }//fim switch
        }//fim for
    ...
    private void funcCalcular(){
        ...
        if((confere1 == 1) && (confere2 == 1)){
            ...
            Toast.makeText(Jogo3Activity.this, "Acertou! Soma = " + String.valueOf(total), Toast.LENGTH_SHORT).show();
