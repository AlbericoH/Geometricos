...
import br.com.geometricos.geometricos.Jogo4Activity;
import br.com.geometricos.geometricos.R;

public class Jogo33Activity extends AppCompatActivity {
    ...
    private void configurarSpinner(){
        ...
        spinnerA.getBackground().setColorFilter(Color.parseColor("#00ffff"), PorterDuff.Mode.SRC_ATOP);
        spinnerB.getBackground().setColorFilter(Color.parseColor("#00ffff"), PorterDuff.Mode.SRC_ATOP);
        spinnerC.getBackground().setColorFilter(Color.parseColor("#00ffff"), PorterDuff.Mode.SRC_ATOP);
        spinnerD.getBackground().setColorFilter(Color.parseColor("#00ffff"), PorterDuff.Mode.SRC_ATOP);
        spinnerE.getBackground().setColorFilter(Color.parseColor("#00ffff"), PorterDuff.Mode.SRC_ATOP);
    ...
    private void funcCalcular(){
        ...
        if((confere1 == 1) && (confere2 == 1)){
            ...
            Toast.makeText(Jogo33Activity.this, "Acertou! Soma = " + String.valueOf(total), Toast.LENGTH_SHORT).show();
            ...
            if(repositorio.selectResultado(NUM_JOGO) == null){
                ...
                somGanhou.start();
                Intent it = new Intent(this, Jogo4Activity.class);
                startActivity(it);
                finish();
            }//fim if
        }//im if
